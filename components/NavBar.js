...
const CustomPhoneLink = ({ href, title, className = '', toggle }) => {
  ...
  return (
    <button
      href={href}
      className={`${className} relative group tex-light dark:text-dark my-2`}
      onClick={handleClick}
    >
      {title}
      <span
...
export default function NavBar() {
  ...
  return (
    ...
    >
      ...
      -translate-x-1/2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32 px-8"
        >
